...
namespace duckdb {
class RelGoClientContext;
class PreparedStatementData;

//! A prepared statement
class RelGoPreparedStatement : public PreparedStatement {
public:
	//! Create a successfully prepared prepared statement object with the given name
	DUCKDB_API RelGoPreparedStatement(shared_ptr<RelGoClientContext> context, shared_ptr<PreparedStatementData> data,
	...
	DUCKDB_API explicit RelGoPreparedStatement(PreservedError error);

	DUCKDB_API ~RelGoPreparedStatement();
