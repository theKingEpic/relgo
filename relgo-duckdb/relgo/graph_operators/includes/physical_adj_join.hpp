...
//                         DuckDB
//
// duckdb/execution/operator/join/physical_adj_join.hpp
//
//
//===----------------------------------------------------------------------===//
...
class PhysicalAdjJoin : public PhysicalJoin, public PhysicalGraphIndexJoin {
public:
  static constexpr const PhysicalOperatorType TYPE =
      PhysicalOperatorType::INDEX_JOIN;

public:
  PhysicalAdjJoin(LogicalOperator &op, unique_ptr<PhysicalOperator> left,
  ...
  void PassBitMaskFilter(relgo::PushDownStatistics &rai_stat) const;
